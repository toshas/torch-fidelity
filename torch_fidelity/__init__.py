...
from torch_fidelity.metric_prc import KEY_METRIC_PRC_PRECISION, KEY_METRIC_PRC_PRECISION
from torch_fidelity.metrics import calculate_metrics
from torch_fidelity.registry import register_dataset, register_feature_extractor, register_sample_similarity, \
    register_noise_source, register_interpolation
